...
class com.ionewmedia.utils.geom.vectores.fuerzas.AtractorConico implements Fuerza {
	//--------------------
	// DOCUMENTACION:
	// Ejerce una fuerza de atraccion constante 'MAX_ATRACCION' dentro del radio marcado por 'RADIO_MAX_ATRACCION'.
	//--------------------
	// PARAMETROS:
	...
	//--------------------
	// CONSTRUCTORA:
	function AtractorConico(_puntoAplicacion:Punto, _puntoOrigen:Punto, maxAtraccion:Number, radioMax:Number){
		trace("(AtractorConico.CONSTRUCTORA)!")

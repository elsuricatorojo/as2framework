...
class com.ionewmedia.utils.geom.vectores.fuerzas.AtractorEmbudo implements Fuerza {
	//--------------------
	// DOCUMENTACION:
	// Ejerce una fuerza de atraccion que aumenta según disminuye la distancia.
	// Dicha fuerza tiene una radio maximo de influencia fuera del cual es 0.
	// Simula un poco la atracción de un planeta o cuerpo estelar.
	//--------------------
	// PARAMETROS:
	...
	public var ceroAplicable:Number = 3
	private var imanActivado:Boolean=false
	//--------------------
	// CONSTRUCTORA:
	function AtractorEmbudo(_puntoAplicacion:Punto, _puntoOrigen:Punto, maxAtraccion:Number, radioMax:Number){
		trace("(AtractorEmbudo.CONSTRUCTORA)!")
	...
	public function getFuerza():Vector {
		...
		if (distancia>=RADIO_MAX_ATRACCION) {
			...
			var ratio:Number = 1-(distancia / RADIO_MAX_ATRACCION)
